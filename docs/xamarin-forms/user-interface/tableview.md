...
description: In questo articolo viene illustrato come utilizzare la classe TableView xamarin. Forms per presentare scorrimento menu, le impostazioni e moduli di input nelle applicazioni.
ms.prod: xamarin
