---
title: Xamarin.FormsInizializzazione e configurazione della mappa
description: Oggetto Xamarin.Forms . Maps il pacchetto NuGet è necessario per usare la funzionalità Maps in un'applicazione. Inoltre, l'accesso alla posizione dell'utente richiede l'autorizzazione per la posizione per l'applicazione.
ms.prod: xamarin
