...
È possibile aggiungere un oggetto `Polygon` a una mappa creandone un'istanza e aggiungendolo alla raccolta di `MapElements` della mappa. Per ottenere questo risultato, è possibile procedere come segue in XAML:
...
È possibile aggiungere un oggetto `Polyline` a una mappa creandone un'istanza e aggiungendolo alla raccolta di `MapElements` della mappa. Per ottenere questo risultato, è possibile procedere come segue in XAML:
