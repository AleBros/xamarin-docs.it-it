...
| `CollectionView` | `Selected` | [Modifica colore elemento selezionato](~/xamarin-forms/user-interface/collectionview/selection.md#change-selected-item-color) |
...
| `VisualElement` | `Normal`, `Disabled`, `Focused` | [Stati comuni](#the-common-states) |
