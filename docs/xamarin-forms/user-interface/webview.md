...
description: In questo articolo viene illustrato come utilizzare la classe di WebView xamarin. Forms per presentare locale o contenuto web di rete e documenti agli utenti.
ms.prod: xamarin
