...
* [`Placeholder`](xref:Xamarin.Forms.InputView.Placeholder) è un `string` che definisce il testo segnaposto, ad esempio "search...".
* [`PlaceholderColor`](xref:Xamarin.Forms.InputView.PlaceholderColor) è un `Color` che definisce il colore del testo segnaposto.
...
* [`Text`](xref:Xamarin.Forms.InputView.Text) è un `string` contenente il testo della query nella `SearchBar`.
* [`TextColor`](xref:Xamarin.Forms.InputView.TextColor) è un `Color` che definisce il colore del testo della query.
