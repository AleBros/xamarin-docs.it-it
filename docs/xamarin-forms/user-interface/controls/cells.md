...
description: È possibile aggiungere controlli ListView e TableViews celle xamarin. Forms. Questo articolo vengono elencati le celle incluse in xamarin. Forms.
ms.prod: xamarin
