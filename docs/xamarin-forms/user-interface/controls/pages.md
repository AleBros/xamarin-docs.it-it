...
description: Pagine di xamarin. Forms rappresentano le schermate di applicazioni per dispositivi mobili multipiattaforma. Questo articolo vengono elencati le pagine che sono inclusi in xamarin. Forms.
ms.prod: xamarin
