...
[Tipi di layout ![Novell. Forms tipi]di(layouts-images/layouts-sml.png "layout Novell. Forms")](layouts-images/layouts.png#lightbox "Tipi di layout Novell. Forms")
...
|     |     |
| --- | --- |
| [`TemplatedView`](xref:Xamarin.Forms.TemplatedView) Visualizza il contenuto con un modello di controllo ed è la classe base per [ `ContentView` ](#contentView).<br /><br />[Documentazione dell'API](xref:Xamarin.Forms.TemplatedView) / [Guida](~/xamarin-forms/app-fundamentals/templates/control-templates/index.md) | [![](layouts-images/TemplatedView.png "Esempio") di esempio di TemplatedView di TemplatedView](layouts-images/TemplatedView.png#lightbox "Esempio di TemplatedView") |
|     |     |
