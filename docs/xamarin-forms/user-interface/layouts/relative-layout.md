...
description: In questo articolo viene illustrato come utilizzare la classe RelativeLayout xamarin. Forms per creare interfacce utente che si adattano per adattare le dimensioni dello schermo.
ms.prod: xamarin
