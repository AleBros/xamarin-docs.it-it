...
- [Visualizzare un'immagine di base dell'orientamento dello schermo](https://developer.xamarin.com/recipes/cross-platform/xamarin-forms/controls/screen-orientation/)
