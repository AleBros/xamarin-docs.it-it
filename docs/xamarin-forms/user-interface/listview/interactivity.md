---
title: ''
description: Questo articolo illustra come aggiungere interattività a un Xamarin.Forms controllo ListView implementando selezioni, azioni di contesto e pull-to-refresh.
ms.prod: ''
ms.assetid: ''
ms.technology: ''
author: ''
