...
description: Questa guida illustra le nozioni di base dei concetti di grafica SkiaSharp e coordinate nelle applicazioni di xamarin. Forms.
ms.prod: xamarin
