...
description: In questo articolo viene illustrato come creare grafica SkiaSharp che rispondono tocco e gli elementi di xamarin. Forms e viene illustrato quanto descritto con codice di esempio.
ms.prod: xamarin
