...
description: In questo articolo vengono illustrati gli effetti e le animazioni possibili con la trasformazione rotativa SkiaSharp e viene illustrato quanto descritto con codice di esempio.
ms.prod: xamarin
