...
description: L'articolo Thhis Esplora la trasformazione scalabilità SkiaSharp per ridimensionare gli oggetti a diverse dimensioni e ne illustra il codice di esempio.
ms.prod: xamarin
