...
description: Articolo Thhis viene esaminata la trasformazione di scala SkiaSharp per ridimensionare gli oggetti per diverse dimensioni e viene illustrato quanto descritto con codice di esempio.
ms.prod: xamarin
