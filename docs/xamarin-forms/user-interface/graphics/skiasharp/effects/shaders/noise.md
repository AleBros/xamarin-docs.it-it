...
Solo il `seed` parametro è selezionabile dall'interfaccia utente. Se lo stesso `seed` modello viene usato in tre piattaforme, Visualizza lo stesso modello. Diversi `seed` valori determinano in modi diversi:
