...
description: In questo articolo viene illustrato come utilizzare SkiaSharp per disegnare linee e percorsi di oggetti graphics in applicazioni di xamarin. Forms e viene illustrato quanto descritto con codice di esempio.
ms.prod: xamarin
