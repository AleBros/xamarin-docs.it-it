...
Il testo stesso è stato scelto per essere anche un po' circolare: la parola "circle" è l'oggetto della frase sia l'oggetto di una frase preposizionali.
