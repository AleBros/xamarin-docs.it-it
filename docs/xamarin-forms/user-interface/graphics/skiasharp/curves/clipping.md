...
description: Questo articolo illustra come usare i percorsi SkiaSharp per ritagliare i grafici in aree specifiche e per creare aree e illustrarlo con il codice di esempio.
ms.prod: xamarin
