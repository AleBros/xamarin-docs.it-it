...
description: Il ImageButton Visualizza un'immagine e risponde a una scelta o a un clic che indirizza un'applicazione per eseguire un'attività specifica.
ms.prod: xamarin
