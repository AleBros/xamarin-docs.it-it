---
title: " Xamarin.Forms CollectionView Introduction" Description: "CollectionView è una visualizzazione flessibile ed efficiente per la presentazione di elenchi di dati usando specifiche di layout diverse".
ms. prod: Novell MS. AssetID: 5C08F687-B9E6-4CE4-8726-F287F6D0B6A7 ms. Technology: Novell-Forms Author: davidbritch ms. Author: dabritch ms. Date: 12/11/2019 no-loc: [ Xamarin.Forms , Xamarin.Essentials ]
---
