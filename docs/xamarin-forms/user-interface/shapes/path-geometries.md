---
title: 'Xamarin.FormsForme: geometrie del percorso'
description: Xamarin.FormsLe classi Geometry del percorso consentono di descrivere la geometria di una forma 2D.
ms.prod: xamarin
...
ms.locfileid: "85101864"
---
# <a name="xamarinforms-shapes-path-geometries"></a>Xamarin.FormsForme: geometrie del percorso
