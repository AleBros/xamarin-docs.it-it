---
title: Modalità colore VisualElement Legacy a Windows
description: Funzionalità specifiche della piattaforma consentono di utilizzare funzionalità che è disponibile solo in una piattaforma specifica, senza implementare renderer personalizzati o gli effetti. Questo articolo illustra come usare Windows specifico della piattaforma che disabilita la modalità di colore legacy di xamarin. Forms.
ms.prod: xamarin
...
ms.locfileid: "65924847"
---
# <a name="visualelement-legacy-color-mode-on-windows"></a>Modalità colore VisualElement Legacy a Windows
...
Questo specifico della piattaforma (Universal Windows Platform) disabilita questa modalità colore legacy, in modo che i colori impostati su una vista dall'utente rimangono anche quando la visualizzazione è disabilitata. Vengono utilizzati in XAML, impostando il [ `VisualElement.IsLegacyColorModeEnabled` ](xref:Xamarin.Forms.PlatformConfiguration.WindowsSpecific.VisualElement.IsLegacyColorModeEnabledProperty) proprietà associata `false`:
