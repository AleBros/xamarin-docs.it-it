...
description: Seguire questi passaggi per convertire le app Android di xamarin. Forms esistenti per l'utilizzo delle applicazioni e materiale di progettazione
ms.prod: xamarin
