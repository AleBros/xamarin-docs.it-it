...
[![](ios-images/picker-updatemode.png "Selezione UpdateMode specifiche della piattaforma")](ios-images/picker-updatemode-large.png#lightbox "selezione UpdateMode specifiche della piattaforma")
...
- Impostazione dello stile di presentazione delle pagine modali in un iPad. Per altre informazioni, vedere [impostando lo stile della presentazione pagina modale in un iPad](#modal-page-presentation-style).
...
### <a name="setting-the-modal-page-presentation-style-on-an-ipad"></a>Impostazione dello stile di presentazione pagina modale in un iPad

Questo specifico della piattaforma viene utilizzato per impostare lo stile di presentazione di una pagina modale in un iPad. Vengono utilizzati in XAML, impostando il `Page.ModalPresentationStyle` la proprietà associabile per un `UIModalPresentationStyle` valore di enumerazione:
...
[![](ios-images/modal-presentation-style-small.png "Modale gli stili di presentazione in un iPad")](ios-images/modal-presentation-style-large.png#lightbox "modale gli stili di presentazione in un iPad")
...
[![](ios-images/scrollview-delay-content-touches.png "Il contenuto di ritardo ScrollView tocca specifiche della piattaforma")](ios-images/scrollview-delay-content-touches-large.png#lightbox "ritardo ScrollView contenuto tocca specifiche della piattaforma")
...
- L'abilitazione di layout del controllo e gli aggiornamenti da eseguire sul thread principale di rendering. Per altre informazioni, vedere [la gestione degli aggiornamenti di controllo nel Thread principale](#update-on-main-thread).
...
### <a name="handling-control-updates-on-the-main-thread"></a>Gestione degli aggiornamenti di controllo sul Thread principale

Questo specifico della piattaforma consente il layout dei controlli e gli aggiornamenti da eseguire sul thread principale, invece di viene eseguita su un thread in background di rendering. Si dovrebbe essere necessario raramente, ma in alcuni casi potrebbe impedire arresti anomali del sistema. Relativo utilizzate in XAML, impostando il `Application.HandleControlUpdatesOnMainThread` la proprietà associabile per `true`:
