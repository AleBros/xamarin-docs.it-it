---
title: Modalità di colore VisualElement Legacy in iOS
description: Funzionalità specifiche della piattaforma consentono di utilizzare funzionalità che è disponibile solo in una piattaforma specifica, senza implementare renderer personalizzati o gli effetti. Questo articolo illustra come usare iOS specifico della piattaforma che disabilita la modalità di colore legacy di xamarin. Forms.
ms.prod: xamarin
...
ms.locfileid: "65926735"
---
# <a name="visualelement-legacy-color-mode-on-ios"></a>Modalità di colore VisualElement Legacy in iOS
...
Questo specifico della piattaforma iOS disabilita questa modalità colore legacy in un [ `VisualElement` ](xref:Xamarin.Forms.VisualElement), in modo che rimangano anche i colori impostati su una vista dall'utente quando la visualizzazione è disabilitata. Vengono utilizzati in XAML, impostando il [ `VisualElement.IsLegacyColorModeEnabled` ](xref:Xamarin.Forms.PlatformConfiguration.iOSSpecific.VisualElement.IsLegacyColorModeEnabledProperty) proprietà associata `false`:
