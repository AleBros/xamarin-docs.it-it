---
title: Modalità di colore testo barra NavigationPage in iOS
description: Funzionalità specifiche della piattaforma consentono di utilizzare funzionalità che è disponibile solo in una piattaforma specifica, senza implementare renderer personalizzati o gli effetti. Questo articolo illustra come usare iOS specifiche della piattaforma che controlla se lo stato della barra di colore del testo in un NavigationPage corrisponde la luminosità della barra di spostamento.
ms.prod: xamarin
...
ms.locfileid: "61081143"
---
# <a name="navigationpage-bar-text-color-mode-on-ios"></a>Modalità di colore testo barra NavigationPage in iOS
