---
title: "voce relativa alla dimensione del carattere in iOS" Descrizione: "le specifiche della piattaforma consentono di utilizzare funzionalità disponibili solo su una piattaforma specifica, senza implementare Renderer o effetti personalizzati. Questo articolo illustra come usare la specifica della piattaforma iOS che ridimensiona le dimensioni del carattere di una voce ".
ms. prod: Novell MS. AssetID: E8881D4E-902B-4397-A43E-916B2885EC87 ms. Technology: Novell-Forms Author: davidbritch ms. Author: dabritch ms. Date: 10/24/2018 no-loc: [ Xamarin.Forms , Xamarin.Essentials ]
---
