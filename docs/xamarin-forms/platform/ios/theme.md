...
description: In questo articolo illustra come impostare l'aspetto specifico di iOS senza utilizzare un renderer personalizzato xamarin. Forms.
ms.prod: xamarin
