...
description: 'Creazione di app per dispositivi mobili con Novell. Forms: Riepilogo del capitolo 3. Dettagli della gestione del testo'
ms.prod: xamarin
...
(Nota: I termini *limitati* e non *vincolati* potrebbero essere controintuitivi, perché una visualizzazione non vincolata è generalmente inferiore a una vista vincolata. Inoltre, le presenti condizioni non vengono utilizzate in modo coerente nei primi capitoli del libro.)
...
- Android: Testo chiaro su uno sfondo scuro (nel libro) o testo scuro su uno sfondo chiaro (per la progettazione del materiale tramite AppCompat nel ramo **Master** del repository di codice di esempio)
