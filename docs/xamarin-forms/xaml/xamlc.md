---
title: Compilazione di XAML in xamarin. Forms
description: Questo articolo spiega come XAML può essere facoltativamente compilato direttamente in linguaggio intermedio (IL) con il compilatore XAML xamarin. Forms (XAMLC).
ms.prod: xamarin
...
ms.locfileid: "35245745"
---
# <a name="xaml-compilation-in-xamarinforms"></a>Compilazione di XAML in xamarin. Forms
