...
* [Visual Studio 2017 versione 15.7 o versione successiva](https://visualstudio.microsoft.com/vs/) o versione successiva con il **sviluppo per dispositivi Mobile con .NET** carico di lavoro.
...
2. Aggiungere il **Xamarin.LiveReload** pacchetto NuGet:
    ...
    [![Aggiungere NuGet di Xamarin Ricarica in tempo reale con Gestione pacchetti NuGet](images/addlivereloadnuget.w157-sml.png)](images/addlivereloadnuget.w157.png#lightbox)
