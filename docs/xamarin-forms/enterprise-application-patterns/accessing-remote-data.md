...
description: In questo capitolo viene illustrato come l'app mobile eShopOnContainers accede ai dati da microservizi nei contenitori.
ms.prod: xamarin
