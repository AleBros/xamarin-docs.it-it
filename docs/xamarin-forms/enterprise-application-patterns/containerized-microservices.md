...
- Immagine del contenitore: un'immagine è costituita da un'Unione di filesystem sovrapposti sovrapposti l'una all'altra e costituisce la base di un contenitore. Un'immagine non ha lo stato e non cambia mai mentre viene distribuita in ambienti diversi.
- Container: un contenitore è un'istanza di runtime di un'immagine.
