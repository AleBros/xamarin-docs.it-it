...
#### [Parte 1: guida introduttiva](get-started/hello-xamarin-forms/quickstart.md)
#### [Parte 2: approfondimento](get-started/hello-xamarin-forms/deepdive.md)
### [Hello, Xamarin.Forms Multiscreen](get-started/hello-xamarin-forms-multiscreen/index.md)
#### [Parte 1: guida introduttiva](get-started/hello-xamarin-forms-multiscreen/quickstart.md)
#### [Parte 2: approfondimento](get-started/hello-xamarin-forms-multiscreen/deepdive.md)
### [Introduzione a Xamarin.Forms](get-started/introduction-to-xamarin-forms.md)
## [XAML](xaml/index.md)
### [Nozioni di base su XAML](xaml/xaml-basics/index.md)
#### [Parte 1. Introduzione a XAML](xaml/xaml-basics/get-started-with-xaml.md)
...
### [Ricaricamento in tempo reale](xaml/live-reload.md)
### [Visualizzatore anteprima XAML](xaml/xaml-previewer.md)
...
#### [Impostazione dei valori di accessibilità per elementi dell'interfaccia utente](app-fundamentals/accessibility/setting-accessibility-values.md)
...
#### [Visualizzazione di popup](app-fundamentals/navigation/pop-ups.md)
...
##### [Nozioni di base sul disegno con SkiaSharp](user-interface/graphics/skiasharp/basics/index.md)
###### [Disegno di un cerchio semplice](user-interface/graphics/skiasharp/basics/circle.md)
###### [Integrazione con Xamarin.Forms](user-interface/graphics/skiasharp/basics/integration.md)
###### [Pixel e unità di misura indipendenti dal dispositivo](user-interface/graphics/skiasharp/basics/pixels.md)
###### [Animazione di base](user-interface/graphics/skiasharp/basics/animation.md)
###### [Integrazione di testo e grafica](user-interface/graphics/skiasharp/basics/text.md)
###### [Nozioni di base sulle bitmap](user-interface/graphics/skiasharp/basics/bitmaps.md)
##### [Linee e tracciati in SkiaSharp](user-interface/graphics/skiasharp/paths/index.md)
###### [Linee ed estremità dei tratti](user-interface/graphics/skiasharp/paths/lines.md)
###### [Nozioni di base sui tracciati](user-interface/graphics/skiasharp/paths/paths.md)
###### [Tipi di riempimento dei tracciati](user-interface/graphics/skiasharp/paths/fill-types.md)
###### [Polilinee ed equazioni parametriche](user-interface/graphics/skiasharp/paths/polylines.md)
###### [Punti e trattini](user-interface/graphics/skiasharp/paths/dots.md)
###### [Disegno con le dita](user-interface/graphics/skiasharp/paths/finger-paint.md)
##### [Trasformazioni di SkiaSharp](user-interface/graphics/skiasharp/transforms/index.md)
###### [Trasformazione di traslazione](user-interface/graphics/skiasharp/transforms/translate.md)
###### [Trasformazione di ridimensionamento](user-interface/graphics/skiasharp/transforms/scale.md)
###### [Trasformazione di rotazione](user-interface/graphics/skiasharp/transforms/rotate.md)
###### [Trasformazione di inclinazione](user-interface/graphics/skiasharp/transforms/skew.md)
###### [Trasformazioni con matrice](user-interface/graphics/skiasharp/transforms/matrix.md)
###### [Manipolazioni tramite tocco](user-interface/graphics/skiasharp/transforms/touch.md)
###### [Trasformazioni non affini](user-interface/graphics/skiasharp/transforms/non-affine.md)
###### [Rotazione 3D](user-interface/graphics/skiasharp/transforms/3d-rotation.md)
##### [Curve e tracciati in SkiaSharp](user-interface/graphics/skiasharp/curves/index.md)
###### [Tre modi per disegnare un arco](user-interface/graphics/skiasharp/curves/arcs.md)
###### [Tre tipi di curve di Bézier](user-interface/graphics/skiasharp/curves/beziers.md)
###### [Dati del tracciato SVG](user-interface/graphics/skiasharp/curves/path-data.md)
###### [Ritaglio con tracciati e aree](user-interface/graphics/skiasharp/curves/clipping.md)
###### [Effetti per il tracciato](user-interface/graphics/skiasharp/curves/effects.md)
###### [Tracciati e testo](user-interface/graphics/skiasharp/curves/text-paths.md)
###### [Informazioni sui tracciati ed enumerazione](user-interface/graphics/skiasharp/curves/information.md)
##### [Bitmap SkiaSharp](user-interface/graphics/skiasharp/bitmaps/index.md)
###### [Visualizzazione di bitmap](user-interface/graphics/skiasharp/bitmaps/displaying.md)
###### [Creazione e disegno nelle bitmap](user-interface/graphics/skiasharp/bitmaps/drawing.md)
###### [Ritaglio di bitmap](user-interface/graphics/skiasharp/bitmaps/cropping.md)
###### [Visualizzazione segmentata delle bitmap](user-interface/graphics/skiasharp/bitmaps/segmented.md)
###### [Salvataggio di bitmap nei file](user-interface/graphics/skiasharp/bitmaps/saving.md)
###### [Accesso ai bit dei pixel delle bitmap](user-interface/graphics/skiasharp/bitmaps/pixel-bits.md)
###### [Animazione di bitmap](user-interface/graphics/skiasharp/bitmaps/animating.md)
#### [Uso di UrhoSharp in Xamarin.Forms](user-interface/graphics/urhosharp.md)
...
#### [AppCompat e Material Design](platform/android/appcompat.md)
### [Indicizzazione e deep linking delle applicazioni](platform/deep-linking.md)
### [Classe Device](platform/device.md)
### [iOS](platform/ios/index.md)
#### [Formattazione](platform/ios/theme.md)
### [GTK#](platform/gtk.md)
### [Mac](platform/mac.md)
...
#### [Utilizzo di funzionalità specifiche della piattaforma](platform/platform-specifics/consuming/index.md)
...
#### [Creazione di funzionalità specifiche della piattaforma](platform/platform-specifics/creating.md)
### [Plug-in](platform/plugins.md)
### [Tizen](platform/tizen.md)
### [Windows](platform/windows/index.md)
#### [Configurazione](platform/windows/installation/index.md)
### [WPF](platform/wpf.md)
...
### [Trasferimento dati](~/essentials/data-transfer.md?context=xamarin/xamarin-forms)
...
### [Potenza](~/essentials/power.md?context=xamarin/xamarin-forms)
### [Preferenze](~/essentials/preferences.md?context=xamarin/xamarin-forms)
### [Blocco dello schermo](~/essentials/screen-lock.md?context=xamarin/xamarin-forms)
...
## [Note sulla versione](https://developer.xamarin.com/releases/xamarin-forms/)
