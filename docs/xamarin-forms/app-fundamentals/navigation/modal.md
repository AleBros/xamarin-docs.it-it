...
> [!NOTE]
> Oggetto [ `NavigationPage` ](https://developer.xamarin.com/api/type/Xamarin.Forms.NavigationPage/) istanza non è necessaria per l'esecuzione di navigazione a pagina modale.
