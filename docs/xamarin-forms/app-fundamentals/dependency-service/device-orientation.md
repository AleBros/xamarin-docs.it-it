...
description: In questo articolo viene illustrato come utilizzare la classe DependencyService xamarin. Forms per accedere a orientamento del dispositivo da codice condiviso.
ms.prod: xamarin
