...
> [!NOTE]
> **Nota**: le classi che implementano l'interfaccia devono avere un costruttore senza parametri per funzionare con il `DependencyService`. Non è possibile definire costruttori per le interfacce.
