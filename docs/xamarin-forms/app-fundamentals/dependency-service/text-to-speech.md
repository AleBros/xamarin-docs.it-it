...
description: In questo articolo viene illustrato come utilizzare la classe di xamarin. Forms DependencyService eseguire chiamate nell'API di sintesi vocale native di ciascuna piattaforma.
ms.prod: xamarin
