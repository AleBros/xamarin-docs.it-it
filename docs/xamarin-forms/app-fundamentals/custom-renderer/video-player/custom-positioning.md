...
description: In questo articolo viene illustrato come implementare un indicatore di posizione personalizzata in un'applicazione di lettore video, usare xamarin. Forms.
ms.prod: xamarin
