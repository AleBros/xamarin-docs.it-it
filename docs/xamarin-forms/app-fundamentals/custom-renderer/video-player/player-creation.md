...
Il [ `VideoPlayer` ](https://github.com/xamarin/xamarin-forms-samples/blob/master/CustomRenderers/VideoPlayerDemos/VideoPlayerDemos/VideoPlayerDemos/VideoPlayer.cs) classe fa parte di **VideoPlayerDemos** libreria di classi portabile (PCL) condiviso tra le piattaforme. Deriva da `View`:
