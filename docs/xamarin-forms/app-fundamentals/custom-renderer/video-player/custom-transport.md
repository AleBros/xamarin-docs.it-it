...
description: In questo articolo viene illustrato come implementare i controlli di trasporto personalizzato in un'applicazione di lettore video, usare xamarin. Forms.
ms.prod: xamarin
