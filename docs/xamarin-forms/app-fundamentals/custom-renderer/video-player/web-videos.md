...
description: In questo articolo viene illustrato come riprodurre video web in un'applicazione di lettore video, usare xamarin. Forms.
ms.prod: xamarin
