...
1. In **MainPage.xaml** modificare la dichiarazione [`ListView`](xref:Xamarin.Forms.ListView) per impostare la proprietà [`ItemsSource`](xref:Xamarin.Forms.ItemsView`1.ItemsSource) sulla raccolta `Monkeys`:
