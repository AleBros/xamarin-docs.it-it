...
description: Questo documento viene descritto come impostare Xamarin Player in tempo reale e usarlo per apportare modifiche in tempo reale a un'applicazione in esecuzione.
ms.prod: xamarin
