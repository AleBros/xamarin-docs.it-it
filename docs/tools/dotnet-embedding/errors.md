...
description: Questo documento descrive gli errori generati incorporando .NET. Gli errori sono elencati in base al codice e una descrizione per facilitare la risoluzione dei problemi.
ms.prod: xamarin
...
ms.locfileid: "34793718"
---
# <a name="net-embedding-errors"></a>Errori durante l'incorporamento .NET
