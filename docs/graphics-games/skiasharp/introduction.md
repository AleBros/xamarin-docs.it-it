...
La libreria è attualmente disponibile come una libreria multipiattaforma [pacchetto NuGet](https://www.nuget.org/packages/SkiaSharp), è possibile per il progetto aggiungendo il riferimento di NuGet.
