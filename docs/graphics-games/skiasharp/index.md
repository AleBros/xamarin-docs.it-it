...
Per consentire agli utenti guidato nostri sforzi di associazione, lasciare commenti o suggerimenti come problemi nel repository GitHub [http://github.com/mono/SkiaSharp](http://github.com/mono/SkiaSharp).
