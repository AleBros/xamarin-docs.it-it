...
ms.locfileid: "67675124"
---
# <a name="skiasharp-platform-specific-notes"></a>Note specifiche della piattaforma di SkiaSharp

Gli esempi seguenti allocare il buffer immagine manualmente, questa operazione viene eseguita per illustrare un modello di piattaforma comune, che consiste nel disegnare su un buffer RGBA esistente fornito dalla piattaforma.
