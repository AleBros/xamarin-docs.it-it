...
description: Questo documento viene descritto come utilizzare iOS 11 Framework Vision in xamarin. IOS. In particolare, viene descritto il rilevamento rettangolo e rilevamento.
ms.prod: xamarin
