...
14. A questo punto è necessario configurare il progetto Xamarin.iOS in modo da usare il profilo di provisioning appena creato. Questa operazione viene eseguita dalla finestra di dialogo **Opzioni progetto** , nella scheda **firma bundle iOS** , come illustrato nello screenshot seguente:  
