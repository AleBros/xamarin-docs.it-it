...
> [!IMPORTANT]
> **Nota:** tramite il **salvare per il Web** o **esportare asset** funzionalità disponibili in software di modifica delle immagini più diffusi _non_ funzionano per le immagini di colori ampia dopo Queste funzionalità non sono state aggiornate per le specifiche di formato di file richiesto è ancora supportata.
