...
## <a name="contacts-and-contactsui"></a>[Contacts e ContactsUI](~/ios/platform/contacts.md)
...
## <a name="document-picker"></a>[Selezione documenti](~/ios/platform/document-picker.md)
...
## <a name="ios-extensions"></a>[estensioni iOS](~/ios/platform/extensions.md)
...
## <a name="graphics-and-animation-in-ios"></a>[Grafica e animazione in iOS](~/ios/platform/graphics-animation-ios/index.md)
...
## <a name="in-app-purchasing"></a>[Acquisto in-app](~/ios/platform/in-app-purchasing/index.md)
...
## <a name="ios-gaming-apis"></a>[API per giochi iOS](~/ios/platform/gaming/index.md)
...
## <a name="message-app-integration"></a>[Integrazione dell'app Message](~/ios/platform/message-app-integration/index.md)
...
## <a name="multitasking-for-ipad"></a>[Multitasking per iPad](~/ios/platform/multitasking.md)

iOS 9 aggiunge il supporto multitasking per l'esecuzione di due app allo stesso tempo su hardware iPad specifico. Il multitasking per iPad è supportato tramite le funzionalità seguenti: scorrere, suddividere la visualizzazione & immagine nell'immagine.
...
## <a name="request-app-review"></a>[Richiedi Revisione app](~/ios/platform/request-app-review.md)
...
## <a name="search-apis"></a>[API per la ricerca](~/ios/platform/search/index.md)
...
## <a name="speech-recognition"></a>[Riconoscimento vocale](~/ios/platform/speech.md)
...
## <a name="touch-id-and-face-id-with-xamarinios"></a>[Touch ID e Face ID con Novell. iOS](~/ios/platform/touch-id-face-id.md)
...
## <a name="user-notifications"></a>[Notifiche utente](~/ios/platform/user-notifications/index.md)
...
## <a name="wide-color"></a>[Wide Color](~/ios/platform/wide-color.md)
...
## <a name="binding-objective-c"></a>[Binding di Objective-C](binding-objective-c/index.md)
...
## <a name="bind-ios-swift-libraries"></a>[Associa le librerie Swift iOS](binding-swift/index.md)

Questo documento descrive come creare C# binding per il codice Swift, rendendo possibile l'utilizzo di librerie native e CocoaPods in un'applicazione Novell. iOS.

## <a name="referencing-native-libraries"></a>[Riferimento a librerie native](native-interop.md)
...
## <a name="embedded-frameworks"></a>[Framework incorporati](embedded-frameworks.md)
