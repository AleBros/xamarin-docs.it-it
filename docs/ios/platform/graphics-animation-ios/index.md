...
##  <a name="walkthrough---using-core-graphics-and-core-animationiosplatformgraphics-animation-iosgraphics-animation-walkthroughmd"></a>[Procedura dettagliata: utilizzo Core grafica e animazione Core](~/ios/platform/graphics-animation-ios/graphics-animation-walkthrough.md)
