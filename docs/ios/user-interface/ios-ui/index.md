...
description: Questo documento include collegamenti alle guide che illustrano come creare interfacce utente nelle app xamarin. IOS. Le guide collegate illustrano le API di aspetto, la creazione di oggetti dell'interfaccia utente, le opzioni di layout e altro ancora.
ms.prod: xamarin
...
iOS consente molti attributi visivi di controlli dell'interfaccia utente usando le APIs UIAppearance eventuali temi delle.
...
Questo articolo illustra i nuovi tipi di feedback aptico disponibile in iOS 10 e come implementarli in xamarin. IOS.
