...
> [!IMPORTANT]
> `UISearchController` è stato implementato in iOS 8. Se si desidera supportare i dispositivi precedenti a questo, sarà necessario utilizzare `UISearchDisplayController`.
