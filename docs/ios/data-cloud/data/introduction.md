---
title: Introduzione all'archiviazione di dati nelle App xamarin
description: Questo documento vengono descritti vari mezzi di archiviazione dei dati in un'applicazione di xamarin. IOS e fornisce informazioni specifiche sui vantaggi di SQLite.
ms.prod: xamarin
...
ms.locfileid: "34784703"
---
# <a name="introduction-to-data-storage-in-xamarinios-apps"></a>Introduzione all'archiviazione di dati nelle App xamarin
