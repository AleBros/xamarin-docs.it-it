...
description: Questo documento viene descritto come determinare il percorso per un file di database SQLite in un'applicazione di xamarin. IOS. Questi concetti sono rilevanti indipendentemente dal meccanismo di accesso ai dati selezionati.
ms.prod: xamarin
