...
[ ![](system.data-images/edit-references-sml.png "Aggiunta di nuovi riferimenti")](system.data-images/edit-references.png)
...
> [!IMPORTANT]
> **Avviso:** come indicato nell'esempio di codice precedente, è buona prassi per incorporare le stringhe nei comandi SQL in quanto rende il codice vulnerabile a [attacchi SQL injection](http://en.wikipedia.org/wiki/SQL_injection).
