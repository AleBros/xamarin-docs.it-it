...
description: Questo documento descrive come usare System. Data e Mono.Data.Sqlite.dll per accedere ai dati di SQLite in un'applicazione di xamarin. IOS.
ms.prod: xamarin
