...
_L'aggiunta di funzionalità a un'applicazione spesso richiede un'ulteriore configurazione di provisioning. Questa guida illustra la configurazione necessaria per le funzionalità del gruppo di app._
...
Il gruppo di app avrà un identificatore che in genere corrisponde all'ID bundle con ilbiz:, Per l'ID bundle `com.xamarin.WatchSettings` , ad esempio, il gruppo di app sarà `group.com.xamarin.WatchSettings`.
