...
1. Nel [Centro sviluppatori](https://developer.apple.com/account/) fare clic su **ID app** in **identificatori**:
...
7. Scorrere fino alla fine di questa sezione espansa e fare clic su **modifica**.
