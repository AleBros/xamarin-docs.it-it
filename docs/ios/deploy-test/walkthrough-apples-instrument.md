...
description: Questo articolo descrive come usare Apple Instruments per diagnosticare problemi di memoria in un'applicazione iOS compilata con Xamarin. Illustra come avviare Instruments, creare snapshot dell'heap, analizzare la crescita della memoria e molto altro.
ms.prod: xamarin
