...
2. Nella finestra di dialogo nuovo file selezionare **iOS**  >  **elenco proprietà**iOS:
...
5. Fare clic sul verde **+** per creare una nuova voce e immettere `UIRequiredDeviceCapabilities` come nome della chiave:
