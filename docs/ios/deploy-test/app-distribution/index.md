---
title: Panoramica sulla distribuzione delle app Xamarin.iOS
...
---
# <a name="xamarinios-app-distribution-overview"></a>Panoramica sulla distribuzione delle app Xamarin.iOS
...
[![Dopo aver sviluppato l'app iOS, il passaggio successivo consiste nel distribuire l'app agli utenti, come illustrato nella sezione evidenziata di questo diagramma](images/publishingdiagram.png)](images/publishingdiagram.png#lightbox)

Apple offre i seguenti modi per distribuire un'applicazione iOS:

- [**App Store**](#app-store-distribution)
- [**In-house (impresa)**](#in-house-distribution)
- [**Hoc**](#ad-hoc-distribution)
...
## <a name="in-house-distribution"></a>Distribuzione in-house
...
Per ulteriori informazioni su come impostare e come distribuire un'applicazione In-House, si prega di fare riferimento alla guida alla [distribuzione In-House](~/ios/deploy-test/app-distribution/in-house-distribution.md).
...
Per ulteriori informazioni su come impostare e come distribuire un'applicazione In-House, fare riferimento alla guida alla [distribuzione ad hoc](~/ios/deploy-test/app-distribution/ad-hoc-distribution.md).

## <a name="custom-apps-for-business"></a>App personalizzate per le aziende

Apple consente la [distribuzione personalizzata](https://developer.apple.com/business/custom-apps/) delle app alle aziende e all'istruzione. Consulta il [Manuale dell'utente di Apple Business Manager](https://support.apple.com/guide/apple-business-manager/welcome/web) per informazioni.
...
- [Distribuzione in-house](~/ios/deploy-test/app-distribution/in-house-distribution.md)
