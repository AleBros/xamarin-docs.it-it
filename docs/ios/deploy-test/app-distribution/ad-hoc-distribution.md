...
Le applicazioni Novell. iOS possono essere testate dagli utenti tramite la distribuzione *ad hoc* , disponibile sia nel programma Apple Developer che nel programma Apple Developer Enterprise, che consente di testare fino a 100 dispositivi iOS.
...
1. Selezionare il team e fare clic su **Gestisci certificati...**: [ ![ selezione del team](ad-hoc-distribution-images/selectteam.png)](ad-hoc-distribution-images/selectteam.png#lightbox)

2. Fare quindi clic sul pulsante con il **segno più (+)** e selezionare **iOS App Store**: [ ![ selezione iOS App Store](ad-hoc-distribution-images/selectcert.png)](ad-hoc-distribution-images/selectcert.png#lightbox)
...
1. Tornare al portale di provisioning Apple e selezionare **provisioning > distribuzione**: [ ![ selezionare Provisioning > distribuzione](ad-hoc-distribution-images/distribute01.png)](ad-hoc-distribution-images/distribute01.png#lightbox)
...
Per altre informazioni sulla creazione di un pacchetto IPA, vedere la guida del [supporto IPA](~/ios/deploy-test/app-distribution/ipa-support.md) .
