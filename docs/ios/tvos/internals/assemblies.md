...
|Assembly|Aggiunta|Compatibilità API|
|---|---|---|
...
|monotouch.dll|1.0|Questo assembly contiene l' [associazione C# all'API CocoaTouch](https://docs.microsoft.com/dotnet/api/?view=xamarinios-10.8).|
...
|System.ServiceModel.Web.dll|?|[Silverlight](https://msdn.microsoft.com/library/cc838194(VS.95).aspx), più tipi degli spazi dei nomi seguenti: <ul><li>Sistema</li><li>System.ServiceModel.Channels</li><li>System.ServiceModel.Description</li><li>System.ServiceModel.Web</li></ul>|
