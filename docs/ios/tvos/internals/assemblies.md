...
Questo è un elenco degli assembly supportati da Novell per le app Novell. tvOS. L'elenco dettagliato è riportato di seguito.  Alcune omissioni rilevanti includono `System.EnterpriseServices`, lo stack ASP.NET e Windows. Forms.
