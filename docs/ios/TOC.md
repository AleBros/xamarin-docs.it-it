...
##### [Configurazione di Visual Studio 2017](get-started/installation/windows/config-options.md)
#### [Set Up Device for Development (Configurare il dispositivo per lo sviluppo)](get-started/installation/device-provisioning/index.md)
...
#### [Parte 1. Guida rapida](get-started/hello-ios/hello-ios-quickstart.md)
...
#### [Parte 1. Guida rapida](get-started/hello-ios-multiscreen/hello-ios-multiscreen-quickstart.md)
...
#### [Avvisi](user-interface/controls/alerts.md)
...
### [Introduzione a iOS 12](platform/introduction-to-ios12/index.md)
...
#### [Trascinamento e rilascio](platform/introduction-to-ios11/drag-and-drop.md)
...
### [Informazioni sul dispositivo](~/essentials/device-information.md?context=xamarin/ios)
### [Email](~/essentials/email.md?context=xamarin/ios)
### [Helper di file system](~/essentials/file-system-helpers.md?context=xamarin/ios)
### [Torcia elettrica](~/essentials/flashlight.md?context=xamarin/ios)
...
##### [Passaggio 1. Registrazione](~/cross-platform/data-cloud/active-directory/get-started/register.md?context=xamarin/ios)
##### [Passaggio 2. Configurazione](~/cross-platform/data-cloud/active-directory/get-started/configure.md?context=xamarin/ios)
...
### [App Distribution (Distribuzione dell'app)](deploy-test/app-distribution/index.md)
...
#### [Uso delle funzionalità](deploy-test/provisioning/capabilities/index.md)
...
##### [Funzionalità di Apple Pay](deploy-test/provisioning/capabilities/apple-pay-capabilities.md)
##### [Funzionalità Gruppo di app](deploy-test/provisioning/capabilities/app-groups-capabilities.md)
#### [Uso degli entitlement](deploy-test/provisioning/entitlements.md)
...
##### [Cronologia dei rilasci](~/cross-platform/macios/binding/objective-sharpie/releases.md?context=xamarin/ios)
...
### [Nozioni fondamentali sulle applicazioni](watchos/app-fundamentals/index.md)
...
#### [Attività di background](watchos/platform/background-tasks.md)
...
### [Nozioni fondamentali sulle applicazioni](tvos/app-fundamentals/index.md)
...
#### [Avvisi](tvos/user-interface/alerts.md)
#### [Pulsanti](tvos/user-interface/buttons.md)
#### [Visualizzazioni di raccolte](tvos/user-interface/collection-views.md)
...
#### [Visualizzazioni tabelle](tvos/user-interface/table-views.md)
#### [Campi di testo e di ricerca](tvos/user-interface/text-fields-and-search.md)
### [Distribuzione e test](tvos/deploy-test/index.md)
#### [App Distribution (Distribuzione dell'app)](tvos/deploy-test/app-distribution/index.md)
