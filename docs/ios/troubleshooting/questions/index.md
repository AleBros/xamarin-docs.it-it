...
### <a name="can-i-use-a-mac-vm-with-xamarinmac-vmmd"></a>[È possibile utilizzare una macchina virtuale Mac con Xamarin?](mac-vm.md)
...
### <a name="where-can-i-set-my-ios-sdk-locationsios-sdkmd"></a>[In cui è possibile impostare il iOS SDK posizioni?](ios-sdk.md)
...
### <a name="user-location-not-working-in-ios-8ios8-user-locationmd"></a>[Percorso dell'utente non funziona in iOS 8](ios8-user-location.md)
Questa guida viene descritto come modificare Info. plist per abilitare il percorso di utente in iOS 8.

### <a name="where-can-i-find-the-dsym-file-to-symbolicate-ios-crash-logssymbolicate-ios-crashmd"></a>[Dove trovare il file .dSYM symbolicate i registri di arresto anomalo iOS](symbolicate-ios-crash.md)
...
### <a name="how-do-i-set-mono-runtime-environment-variables-for-ios-projects-in-xamarin-studioxs-mono-runtimemd"></a>[Impostazione delle variabili di ambiente di Runtime Mono per i progetti iOS in Studio a Xamarin](xs-mono-runtime.md)
...
### <a name="why-does-my-app-submission-fail-with-disallowed-paths--itunesmetadataplist--found-at--itunesmetadata-disallowed-pathsmd"></a>[Perché non invio my app avrà esito negativo con: "Non consentito percorsi ("iTunesMetadata.plist"), vedere..."?](itunesmetadata-disallowed-paths.md)
...
### <a name="ios-designer-error-with-registerserviceporterror-registerserviceportmd"></a>[Errore di progettazione con RegisterServicePort iOS](error-registerserviceport.md)
...
### <a name="why-does-my-ios-build-fail-with-no-valid-iphone-code-signing-keys-found-in-keychainno-codesigning-keysmd"></a>[Perché viene compilazioni iOS eseguito con: nessun codice iPhone valido le chiavi di firma disponibile nel portachiavi?](no-codesigning-keys.md)
...
### <a name="why-does-my-ios-9-app-fail-with-systemexception-failed-to-marshal-the-objective-c-objectexception-marshal-obj-cmd"></a>[Perché non mia app iOS 9 avrà esito negativo con: System. Exception: Impossibile effettuare il marshalling dell'oggetto Objective-C?](exception-marshal-obj-c.md)
...
### <a name="runtime-error-the-assembly-mscorlibdll-was-not-found-or-could-not-be-loadederror-mscorlib-not-foundmd"></a>[Errore di runtime: l'assembly mscorlib. dll non è stato trovato o non può essere caricato](error-mscorlib-not-found.md)
...
### <a name="ipa-file-is-0-bytesipa-zero-bytesmd"></a>[File IPA è di 0 byte](ipa-zero-bytes.md)
...
### <a name="systemexception-amdevicenotificationsubscribe-returned-exception-amddevicenotificationsubscribemd"></a>[System. Exception AMDeviceNotificationSubscribe restituito...](exception-amddevicenotificationsubscribe.md)
