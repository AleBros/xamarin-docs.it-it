...
*Avviso: Gli errori nei file con estensione csproj possono interrompere il progetto, quindi è consigliabile eseguire il backup dei file prima di provare a eseguire questa operazione.*
