...
layout: HubPage
hide_bc: true
title: Documentazione di Xamarin
...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Configurazione e installazione</h3>
                                    <p>Informazioni su come installare gli strumenti di Visual Studio per Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Esempi</h3>
                                    <p>Esempi di funzionalità e app pronte.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Novità</h3>
                                    <p>Novità nella documentazione di Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Documentazione di Xamarin</h1>
        <ul class="pivots">
            <li>
                <li>
                            ...
                            <li>
                               <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Informazioni su Xamarin</h3>
                                                <h4>Sviluppare app Android e iOS multipiattaforma con Xamarin.Forms usando C# e .NET in Visual Studio in Windows e macOS.</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="~/cross-platform/get-started/introduction-to-mobile-development.md"><img  src="https://docs.microsoft.com/media/logos/logo_xamarin.svg" alt="" />Che cos'è Xamarin?</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Guida rapida</h3>
                                                <h4>Seguire queste guide per creare la prima app Android e iOS multipiattaforma di con Xamarin.Forms, 5 minuti alla volta.</h4>
                                                            ...
                                                            <ul class="noBullet">
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/single-page.md">
                                                                        <img src="~/media/icons/i_xaml-forms.svg" alt=""> File > Nuova app per dispositivi mobili </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/multi-page.md">
                                                                        <img src="https://docs.microsoft.com/media/common/i_class.svg" alt=""> Aggiungere le funzionalità di spostamento </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/database.md">
                                                                        <img src="https://docs.microsoft.com/media/common/i_generic-database.svg" alt=""> Aggiungere un database </a>
                                                                </li>
                                                                 <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/styling.md">
                                                                        <img src="https://docs.microsoft.com/xamarin/media/icons/i_user-interface.svg" alt=""> Definire lo stile dell'app </a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                                                <li>
                                                                    ...
                                                                    <img src="https://docs.microsoft.com/media/common/i_guidelines.svg" alt=""> Linee guida per lo sviluppo Xamarin </a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Esercitazioni</h3>
                                                <h4>Informazioni sui concetti relativi alle app Android e iOS multipiattaforma, con Xamarin.Forms.</h4>
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/stacklayout/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_dashboard.svg" alt=""> Layout pila </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/label/index.yml">
                                                                        <img src="~/media/icons/i_form-label.svg" alt=""> Etichetta </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/button/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_button.svg" alt=""> Pulsanti </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/entry/index.yml">
                                                                        <img src="~/media/icons/i_form-entry.svg" alt=""> Immissione di testo </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/editor/index.yml">
                                                                        <img src="~/media/icons/i_form-editor.svg" alt=""> Editor di testo </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/image/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_account-management.svg" alt=""> Immagini </a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/grid/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_table.svg" alt=""> Layout griglia </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/listview/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_sharepoint-list.svg" alt=""> Elenchi </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/pop-ups/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_alert.svg" alt=""> Popup </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/app-lifecycle/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_agile.svg" alt=""> Ciclo di vita dell'app </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/local-database/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_generic-database.svg" alt=""> Database </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/web-service/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_server.svg" alt=""> Servizi Web </a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Usare la conoscenza esistente</h3>
                                                <h4>I progetti Xamarin consentono di applicare le attuali competenze per compilare app per Android e iOS. Scegliere la piattaforma preferita per altre informazioni:</h4>
                                                ...
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="~/cross-platform/desktop/index.md">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_NET.svg" alt=""> Desktop .NET (UWP, WPF, WinForms)</a>
                                                    </li>
                        ...
                        <ul id="XamarinForms" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>
Xamarin.Forms è un toolkit multipiattaforma per Android, iOS, Mac e Windows che usa C# e .NET. Consente di condividere il codice dell'interfaccia utente, nonché il codice della logica dell'app su tutte le piattaforme.
                                    </p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cos'è Xamarin.Forms?</h3>
                                                    <p>Informazioni su Xamarin.Forms e su come compilare e distribuire app per Android e iOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tutto quello che serve per sviluppare app Xamarin.Forms, ad esempio spostamento, movimenti, data binding e altro ancora.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Informazioni sui controlli dell'interfaccia utente disponibili per le piattaforme supportate.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>XAML</h3>
                                                    <p>Esprimere le interfacce utente multipiattaforma in modo dichiarativo con XAML.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Utilizzo di funzionalità specifiche della piattaforma in Android, iOS e Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>API multipiattaforma per attività delle app comuni.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Dati e Servizi cloud di Azure</h3>
                                                    <p>Archiviazione dei dati e accesso ai servizi cloud di Azure.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Istruzioni per la compilazione e distribuzione delle app e suggerimenti per i test.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Concetti avanzati e meccanismi interni</h3>
                                                    <p>Come funziona Xamarin.Forms.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>App di esempio</h3>
                                                    <p>App complete e demo di codice per Xamarin.Forms, eseguibili in Android, iOS e Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>E-book sulla grafica SkiaSharp</h3>
                                                    <p>Grafica vettoriale e animazione multipiattaforma con SkiaSharp.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Libro sulle app per dispositivi mobili</h3>
                                                    <p>Libro ed esempi con informazioni dettagliate per imparare a usare Xamarin.Forms.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Ebook sulle app aziendali</h3>
                                                    <p>Linee guida sull'architettura per lo sviluppo di applicazioni aziendali Xamarin. Forms facili da adattare, gestire e testare.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Altre informazioni sullo sviluppo con Visual Studio 2019.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Altre informazioni sullo sviluppo .NET in macOS con Visual Studio per Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Simulatore iOS per Windows</h3>
                                                    <p>Interagire con il simulatore iOS con Visual Studio in Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Identificare e correggere i problemi di prestazioni.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>.NET Embedding</h3>
                                                    <p>Consente di utilizzare il codice .NET esistente da altri linguaggi di programmazione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>UrhoSharp</h3>
                                                    <p>Grafica e giochi 3D multipiattaforma.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>Creare giochi per desktop, dispositivi mobili e console con C#.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
