...
9.  Decomprimere il contenuto estratto **AAR** file per il **incorporato** directory. In Windows, aggiungere un **zip** estensione per il **AAR** file, aprirlo e copiare il contenuto per il **incorporato** directory.
    In macOS, decomprimere il **AAR** file utilizzando il **decomprimere** comando Terminal (ad esempio, **decomprimere file.aar**).
