...
Il processo completamente manuale per il ripristino da errori **m2repository** comporta il download del file **android\_m2repository\_r_nn_. zip** (tramite un Web browser), la decompressione e la copia del contenuto nella directory della libreria di supporto nel computer. Nell'esempio seguente verrà ripristinato il messaggio di errore seguente: 
...
1. Elimina il contenuto della cartella della libreria corrispondente al messaggio di errore. Ad esempio, nel messaggio di errore precedente si elimina il contenuto di **C:\\utenti\\***nomeutente***\\AppData\\locale\\Novell\\Android. Support. v4\\23.1.1.0**. 
    ...
    [![l'eliminazione di cartelle di contenuto, incorporate e android_m2repository dalla cartella 23.1.1.0](resolving-library-installation-errors-images/04-delete-contents-vs.png)](resolving-library-installation-errors-images/04-delete-contents-vs.png#lightbox)
