...
[![Immagini hero di Tablet e telefoni in esecuzione Marshmallow](marshmallow-images/android-m-hero-sml.png)](marshmallow-images/android-m-hero.png#lightbox)
...
-   Avviare Android SDK Manager (in Visual Studio per Mac, usare **strumenti > SDK Manager**; in Visual Studio, usare **strumenti > Android > Android SDK Manager**) e installare strumenti di Android SDK più recente:
    ...
    [![Selezionare gli strumenti di Android SDK in Android SDK Manager](marshmallow-images/mnc-preview-tools.png)](marshmallow-images/mnc-preview-tools.png#lightbox)

-   Inoltre, installare la versione più recente **Android 6.0** pacchetti SDK:

    [![Selezionare i pacchetti Android 6.0 SDK in Android SDK Manager](marshmallow-images/mnc-preview-packages.png)](marshmallow-images/mnc-preview-packages.png#lightbox)
...
[![Configurazione di un AVD utilizzando Nexus 5 dispositivi Android 6.0 destinazione e Intel Atom (x86)](marshmallow-images/android-m-avd.png)](marshmallow-images/android-m-avd.png#lightbox)
