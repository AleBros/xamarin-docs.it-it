...
Sebbene la versione marshmallow sia principalmente dedicata alla "Polonia e alla qualità", offre anche molte nuove funzionalità interessanti per gli sviluppatori Novell. Android. Queste funzionalità includono: 
...
- [Panoramica delle caratteristiche](https://developer.android.com/preview/api-overview.html)
