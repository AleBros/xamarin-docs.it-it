...
Le versioni precedenti di Android possono anche usare il `CursorLoader` classe usando il [v4 supporto librerie](http://developer.android.com/tools/support-library/index.html).
