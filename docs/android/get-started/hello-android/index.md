...
_In questa guida in due parti verrà compilata la prima applicazione Xamarin.Android usando Visual Studio per Mac o Visual Studio e si svilupperà una conoscenza dei concetti fondamentali dello sviluppo di applicazioni Android con Xamarin. Lungo il percorso, verranno introdotti gli strumenti, i concetti e i passaggi necessari per compilare e distribuire un'applicazione Xamarin.Android._

## <a name="part-1-quickstart"></a>[Parte 1: Guida introduttiva](~/android/get-started/hello-android/hello-android-quickstart.md)
...
## <a name="part-2-deep-dive"></a>[Parte 2: approfondimento](~/android/get-started/hello-android/hello-android-deepdive.md)
