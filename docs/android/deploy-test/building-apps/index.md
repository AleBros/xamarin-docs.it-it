...
## <a name="build-process"></a>[Processo di compilazione](~/android/deploy-test/building-apps/build-process.md)
...
## <a name="building-abi-specific-apks"></a>[Compilazione di APK specifici di ABI](~/android/deploy-test/building-apps/abi-specific-apks.md)
