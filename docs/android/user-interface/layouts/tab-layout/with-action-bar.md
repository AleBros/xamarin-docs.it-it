...
- [Modello della barra delle azioni](https://developer.android.com/design/patterns/actionbar.html)
- [AppCompat Android v7](https://developer.android.com/tools/support-library/features.html#v7-appcompat)
