...
#### [Anteprima di Microsoft Mobile OpenJDK](get-started/installation/openjdk.md)
...
### [Utilità di avvio](~/essentials/launcher.md?context=xamarin/android)
...
### [Mappe](~/essentials/maps.md?context=xamarin/android)
### [Apri browser](~/essentials/open-browser.md?context=xamarin/android)
### [Sensore di orientamento](~/essentials/orientation-sensor.md?context=xamarin/android)
