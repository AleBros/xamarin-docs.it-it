...
### [Servizi connessi di Azure](~/cross-platform/data-cloud/connected-services.md?context=xamarin/android)
...
#### [Emulatore di Android SDK](deploy-test/debugging/android-sdk-emulator/index.md)
