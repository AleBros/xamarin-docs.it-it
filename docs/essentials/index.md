...
Android, iOS e UWP offrono API specifiche del sistema che gli sviluppatori possono utilizzare in Xamarin sfruttando c#. Xamarin.Essentials fornisce una singola API multipiattaforma utilizzabile con Xamarin.Forms, Android, iOS o applicazione UWP  accessibili da codice condiviso, indipendentemente dal modo in cui viene creata l'interfaccia utente.
...
Seguire le [Guida introduttiva](get-started.md) per installare il pacchetto NuGet di**Xamarin.Essentials**  in un progetto esistente o nuovo di tipo Xamarin.Forms , Android, iOS o UWP.
...
* [Batteria](battery.md?context=xamarin/xamarin-forms) : è possibile rilevare il livello della batteria, l'origine e lo stato
* [Appunti](clipboard.md?context=xamarin/xamarin-forms) :  impostare o leggere rapidamente e facilmente il testo negli Appunti.
* [Compass](compass.md?context=xamarin/xamarin-forms) – monitorare la bussola per le modifiche.
* [Connettività](connectivity.md?context=xamarin/xamarin-forms) : controllare lo stato di connettività e rilevare le modifiche.
* [Trasferimento dati](data-transfer.md?context=xamarin/xamarin-forms) – invia testo e l'indirizzo di un sito ad altre app.
...
* [Helper di file System](file-system-helpers.md?context=xamarin/xamarin-forms) , salvare facilmente file per i dati dell'app.
* [Torcia](flashlight.md?context=xamarin/xamarin-forms) -un modo semplice per attivare/disattivare la torca.
...
* [Il Giroscopio](gyroscope.md?context=xamarin/xamarin-forms) : tenere traccia di rotazione intorno agli assi del dispositivo.
...
* [Apri Browser](open-browser.md?context=xamarin/xamarin-forms) –  aprire rapidamente e facilmente un sito Web specifico.
...
* [Preferenze](preferences.md?context=xamarin/xamarin-forms) – aggiungere rapidamente e facilmente le preferenze del dispositivo in modo permanente.
* [Schermata di blocco](screen-lock.md?context=xamarin/xamarin-forms) – mantenere attivo lo schermo del dispositivo.
...
* [Sintesi vocale](text-to-speech.md?context=xamarin/xamarin-forms) – Leggere del testo sul dispositivo.
...
* [Vibrazione](vibrate.md?context=xamarin/xamarin-forms) – far vibrare il dispositivo.
...
Utilizzare la Guida se si verificano problemi.
