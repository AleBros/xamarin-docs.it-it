...
Ogni volta che viene attivato uno qualsiasi dei chagne le proprietà della batteria un evento:
...
- [Codice sorgente della batteria](https://github.com/xamarin/Essentials/tree/master/Essentials/Battery)
