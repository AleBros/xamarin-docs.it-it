---
title: Suggerimenti sulla risoluzione dei problemi Xamarin.Mac
description: Questo documento descrive gli approcci per la risoluzione dei problemi riscontrati durante lo sviluppo di applicazioni Xamarin.Mac.
ms.topic: article
ms.prod: xamarin
...
---
# <a name="xamarinmac-troubleshooting-tips"></a>Suggerimenti sulla risoluzione dei problemi Xamarin.Mac
