...
4. Miguel fornisce una visualizzazione "Rosetta Stone" APIs Xamarin.Mac [qui](http://tirania.org/tmp/rosetta.html) che è possibile cercare tramite un'API specifica. Se l'API non AppKit o macOS specifico, si può cercarla.
