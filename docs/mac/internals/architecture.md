...
[![Diagramma che mostra una panoramica dell'architettura di base](architecture-images/mac-arch.png "diagramma che mostra una panoramica dell'architettura di base")](architecture-images/mac-arch-large.png)
