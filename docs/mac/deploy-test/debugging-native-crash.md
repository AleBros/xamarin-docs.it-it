---
title: Debug di un arresto anomalo nativo
description: Questa guida descrive come eseguire il debug di eccezioni che hanno origine nel runtime Objective-C.
ms.prod: xamarin
...
---
# <a name="debugging-a-native-crash"></a>Debug di un arresto anomalo nativo
