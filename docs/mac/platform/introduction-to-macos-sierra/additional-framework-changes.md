...
- Ai controlli esistenti sono stati aggiunti diversi costruttori pratici:
  ...
  - `NSImageView`include nuovi costruttori per la creazione di visualizzazioni di immagine non modificabili da un dato oggetto `NSImage` .
