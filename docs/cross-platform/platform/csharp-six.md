...
* **Visual Studio 2015 e 2017** e versioni successive dispongono del supporto completo per c# 6. Versioni precedenti di Visual Studio (ad es. 2013, 2012) non supporta c# 6.
