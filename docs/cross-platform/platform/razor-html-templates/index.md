...
### <a name="calling-javascript-from-c"></a>Chiamata a JavaScript daC#
...
#### <a name="manipulating-the-template-from-c"></a>Manipolazione del modello daC#
