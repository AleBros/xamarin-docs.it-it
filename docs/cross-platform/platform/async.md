...
L'applicazione di esempio effettua una richiesta web asincrona semplice (senza bloccare il thread principale), quindi aggiorna l'interfaccia utente html scaricato e numero di caratteri.
 ...
 [![](async-images/AsyncAwait_427x368.png "L'applicazione di esempio effettua una richiesta web asincrona semplice senza bloccare il thread principale, quindi aggiorna l'interfaccia utente html scaricato e numero di caratteri")](async-images/AsyncAwait.png#lightbox)
