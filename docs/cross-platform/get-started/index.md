...
- [Guida introduttiva di Android](~/android/get-started/hello-android/hello-android-quickstart.md)
- [Guida introduttiva di iOS](~/ios/get-started/hello-ios/hello-ios-quickstart.md)
...
### <a name="what-is-xamarin"></a>[Che cos'è Xamarin?](~/cross-platform/get-started/introduction-to-mobile-development.md)
...
### <a name="mobile-software-development-lifecycle"></a>[Ciclo di vita di sviluppo del software per dispositivi mobili](~/cross-platform/get-started/introduction-to-mobile-sdlc.md)
...
## <a name="building-cross-platform-applications"></a>[Creazione di applicazioni multipiattaforma](~/cross-platform/app-fundamentals/building-cross-platform-applications/index.md)
...
### <a name="introducing-visual-studio-for-mac"></a>[Introduzione a Visual Studio per Mac](https://docs.microsoft.com/visualstudio/mac/)
