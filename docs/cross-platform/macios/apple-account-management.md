...
description: Questo documento descrive come usare le funzionalità di gestione di account di Apple in Visual Studio per Mac e Visual Studio 2017.
ms.prod: xamarin
