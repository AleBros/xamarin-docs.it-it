...
---
# <a name="unified-api"></a>API unificata
...
Descrive la logica alla base dell'API unificata e vengono illustrate le differenze dall'API classico in modo dettagliato. Fare riferimento a questa pagina per comprendere le modifiche apportate nell'API unificata.
...
Per informazioni generali sul supporto di 32 e 64 bit applicazioni e informazioni sui Framework per vedere il [32 e 64 bit considerazioni relative alla piattaforma](~/cross-platform/macios/32-and-64.md).
...
<tr>
    <th>Nome del metodo API classico</th>
    <th>Nome del metodo API unificata</th>
</tr>
<tr>
