...
description: Questo documento vengono descritti i passaggi che devono essere seguiti per aggiornare un'app xamarin. Forms dall'API classica all'API unificata.
ms.prod: xamarin
