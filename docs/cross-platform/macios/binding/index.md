...
description: Questo documento vengono forniti collegamenti alle varie guide che descrivono come creare c# associazioni al codice Objective-C, consentendo agli sviluppatori di utilizzare le librerie predefinite nelle applicazioni di Xamarin.
ms.prod: xamarin
