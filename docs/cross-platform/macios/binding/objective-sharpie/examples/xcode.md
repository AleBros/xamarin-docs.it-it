...
description: Questo documento descrive come usare un progetto Xcode come input diretto per Sharpie obiettivo, semplificando il processo di creazione di associazioni c# per il codice Objective-C.
ms.prod: xamarin
