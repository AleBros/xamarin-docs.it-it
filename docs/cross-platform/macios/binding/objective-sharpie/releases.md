...
description: Questo documento descrive la cronologia delle versioni di Sharpie obiettivo, lo strumento utilizzato per automatizzare la creazione di associazioni di c# al codice Objective-C.
ms.prod: xamarin
