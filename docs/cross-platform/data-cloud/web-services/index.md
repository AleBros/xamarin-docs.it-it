...
[ ![](images/add-webreference-dialog.png "L'URL del servizio web può essere un'origine remota ospitato o risorse di sistema di file locale accessibili tramite il prefisso di percorso di file")](images/add-webreference-dialog.png)
