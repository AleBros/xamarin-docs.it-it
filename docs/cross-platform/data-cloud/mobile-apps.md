...
Informazioni sullo [sviluppo di app per dispositivi mobili con servizi cloud](https://docs.microsoft.com/azure/mobile-apps/), tra cui SignalR, servizi cognitivi, Machine Learning, ancoraggi spaziali, ricerche e altro ancora.
