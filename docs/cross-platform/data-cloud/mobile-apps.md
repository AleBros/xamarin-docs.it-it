...
description: Questo documento include collegamenti ad guide che descrivono come creare un'app Xamarin che è connesso ad Azure. Viene descritto l'utilizzo con il componente di Azure di Xamarin, utenti e le notifiche push.
ms.prod: xamarin
