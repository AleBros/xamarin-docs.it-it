...
description: Questo documento viene descritto come gestire divergenza applicazione in base alle piattaforme o funzionalità. Viene descritto dimensioni dello schermo, metafore di navigazione, tocco e i movimenti, le notifiche push e paradigmi di interfaccia, ad esempio gli elenchi e le schede.
ms.prod: xamarin
