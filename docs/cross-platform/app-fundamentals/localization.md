...
description: Questo documento vengono descritti i concetti multipiattaforma di internazionalizzazione e localizzazione ed esamina modo queste influiscono sulle progettazione dell'applicazione.
ms.prod: xamarin
